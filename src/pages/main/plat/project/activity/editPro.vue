<template>
  <div style="width: 500px; max-width: 100%">
    <q-breadcrumbs class="text-grey q-mb-lg" active-color="primary">
      ...
      <q-breadcrumbs-el label="项目信息" :to="'/plat/project/activity/proInfo?proId='+$route.query.proId" v-if="!addShow" />
      <q-breadcrumbs-el :label="addShow?'新增营销活动':'修改营销活动'" to="/editTicketPro" />
    </q-breadcrumbs>
    ...
    <q-form @submit="onSubmit">
      ...
      <!-- 项目说明 -->
      <q-input :rules="[ val => !!val || '不可为空']" v-model="form.brief" label="项目说明"></q-input>
      <!-- 主页地址 -->
      <q-input v-model="form.homeUrl" label="主页地址"></q-input>
      <!-- 项目状态 -->
