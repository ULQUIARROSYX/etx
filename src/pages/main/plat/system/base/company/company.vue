...
export default {
    ...
    methods: {
        ...
        companyMsg (id) {
            if (id) {
                this.toPath('/plat/system/base/company/editCompany', { companyId: id })
            } else {
                this.toPath('/plat/system/base/company/editCompany')
            }
        },
        // 编辑人员管理
        companyOp (id) {
            this.toPath('/plat/system/base/company/companyOp', { companyId: id })
        },
        // 获取全部信息
        getCompany () {
            this.$axios
